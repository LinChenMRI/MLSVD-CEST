...
PLOFMapFitting(Image_original,Freq,FitParam,Mask,T1map);

FitParam.name = ['Noisy'];
PLOFMapFitting(Image_noisy,Freq,FitParam,Mask,T1map);

FitParam.name = ['MLSVD'];
PLOFMapFitting(Image_MLSVD,Freq,FitParam,Mask,T1map);