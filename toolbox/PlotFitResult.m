...
figure;drawnow;
hold on
plot(FitResult.Offset,FitResult.Saturation,'o','LineWidth',2.5,'MarkerSize',9,'Color',linecolors(1,:));
plot(FitResult.Offset_background,FitResult.Saturation_background,'X','LineWidth',2.5,'MarkerSize',9,'Color',linecolors(3,:));
plot(FitResult.xindex,FitResult.Curve,'-','LineWidth',2.5,'MarkerSize',9,'Color',linecolors(2,:));
plot(FitResult.xindex,FitResult.Background,'-','LineWidth',2.5,'MarkerSize',9,'Color',linecolors(4,:));
...
box on
set (gcf,'Position',[100,100,623 503], 'color','w');
